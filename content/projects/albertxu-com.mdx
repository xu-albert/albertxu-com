...
Migrating over from Squarespace was shockingly quite easy. I used Claude Code to handle the heavy lifting while I made some high-level decisions.
...
I wanted a blog that supported MDX so I could write posts in Markdown with embedded React components. One example feature is the ability to render [Mermaid](https://mermaid.js.org/) diagrams.
